...
public class CDiscountUtils {
	...
	public static void setApiKey(String filePath) throws Exception {
	...
	public static JSONObject search(String keywords, int minPrice, int maxPrice) throws Exception {
	...
	public static JSONObject getProduct(List<String> productIdList) throws Exception {
	...
	private static JSONObject sendToCDiscount(JSONObject request, String urlString) throws Exception {
		JSONObject response = null;

		/*
		 * https://stackoverflow.com/questions/21404252/post-request-send-json-data-java
		 * -httpurlconnection
		 */
